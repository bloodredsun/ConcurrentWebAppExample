...
import com.bloodredsun.concurrent.task.RemoteCallable;
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            for (int ii = 0; ii < 10; ii++) {
                remoteCallables.add(new RemoteCallable(remoteClient));
            }

            List<Future<String>> futures = executorService.invokeAll(remoteCallables);
